      ...
      <div ref={workRef} className="min-h-screen bg-white text-black py-24 lg:py-40 overflow-hidden">
        ...
        <div className='main-container pb-8 lg:pb-12 flex max-md:flex-col gap-6 justify-between items-start md:items-end'>
          <div className='max-w-xl'>
            <h3 className='mb-3'>Club Projects</h3>
            <p className='text-lg lg:text-xl'>A showcase of our <span className="font-decorative">collaborative</span> projects—built by members, designed to <span className="font-decorative">inspire</span>, and crafted to solve <span className="font-decorative">real-world problems</span>.</p>
          </div>
